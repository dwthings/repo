...
def log_tools():
	errors = int(errorChecking(count=False))
	err = str(errors)
...
class Guiwiz(pyxbmct.AddonDialogWindow):
	...
	def foreground(self):
		...
		self.placeControl(self.listbg, 10, 5, 80, 13)

		self.buildbg = pyxbmct.Image(LISTBG)
		self.placeControl(self.buildbg, 10, 18, 80, 27)

		self.buildinfobg = pyxbmct.Image(LISTBG)
		self.placeControl(self.buildinfobg, 90, 5, 20, 40)

		self.listbgA = pyxbmct.Image(LISTBG)
		self.placeControl(self.listbgA, 20, 5, 80, 17)

		self.buildbgA = pyxbmct.Image(LISTBG)
		self.placeControl(self.buildbgA, 20, 16, 80, 35)

		self.maintbg = pyxbmct.Image(LISTBG)
		self.placeControl(self.maintbg, 70, 20, 40, 25)

		self.sysinfobg = pyxbmct.Image(LISTBG)
		self.placeControl(self.sysinfobg, 10, 20, 60, 25)

		self.netinfobg = pyxbmct.Image(LISTBG)
		self.placeControl(self.netinfobg, 10, 5, 60, 15)

		self.speedthumb = pyxbmct.Image(SpeedBG)
		self.placeControl(self.speedthumb, 70, 5, 40, 15)

		self.splash = pyxbmct.Image(SPLASH)
		self.placeControl(self.splash , 10, 5, 100, 40)

		self.bakresbg = pyxbmct.Image(LISTBG)
		self.placeControl(self.bakresbg , 10, 5, 100, 40)

		self.toolsbg = pyxbmct.Image(LISTBG)
		self.placeControl(self.toolsbg , 10, 5, 100, 40)
	...
	def main_buttons(self):
		...
		self.placeControl(self.BuildsButton, 1, 5, 9, 8)
		...
		self.placeControl(self.MaintButton, 1, 13, 9, 8)
		...
		self.placeControl(self.BackResButton, 1, 21, 9, 8)
		...
		self.placeControl(self.ToolsButton, 1, 29, 9, 8)
		...
		self.placeControl(self.CloseButton, 1, 37 ,9 ,8)
	...
	def BuildList(self):
		...
		if not BUILDFILE == 'http://' and not BUILDFILE == '':
			...
			self.placeControl(vertextbox, 56, 20, 10, 15)
		
			koditextbox  = pyxbmct.Label('',textColor='0xFFFFFFFF')
			self.placeControl(koditextbox, 50, 20, 10, 15)
		
			desctextbox = pyxbmct.TextBox()
			self.placeControl(desctextbox, 65, 20, 18, 23)
			...
			FreshStartButton.controlDown(buildlistmenu)
	...
	def Maint(self):
		...
		self.placeControl(total_cache_button, 87 , 21 ,  9, 7)
		...
		self.placeControl(total_packages_button, 87 , 29 ,  9, 7)
		...
		self.placeControl(total_thumbnails_button, 87 , 37 ,  9, 7)
		...
		self.placeControl(speedtest_button, 58 , 6 ,  9, 6)
		...
		self.placeControl(un_hide_net, 58, 13, 9, 6)
		...
		self.placeControl(settings_button1, 72 , 37 ,  9, 7)
	...
	def BackRes(self):
		...
		self.placeControl(backup_gui_button, 52, 6, 10, 10)
		...
		self.placeControl(backupaddonpack_button, 62, 6, 10, 10)
		...
		self.placeControl(backup_addondata_button, 72, 6, 10, 10)
		...
		self.placeControl(savefav_button, 82, 6, 10, 10)
		...
		self.placeControl(delete_title, 54, 34, 10, 10)
		...
		self.placeControl(clearfav_button, 64, 34, 10, 10)
	...
	def Tools(self):
		...
		self.placeControl(full_log_button, 40, 6, 9, 9)
		...
		self.placeControl(upload_log_button, 49, 6, 9, 9)
		...
		self.placeControl(scan, 75, 6, 9, 10)
		...
		self.placeControl(checksources_button, 82, 6, 9, 8)
		...
		self.placeControl(checkrepos_button, 92, 6, 9, 8)
		...
		self.placeControl(forceupdate_button, 82, 16, 9, 8)
		...
		self.placeControl(fixaddonupdate_button, 92, 16, 9, 8)
		...
		self.placeControl(delet, 75, 26, 9, 10)
		...
		self.placeControl(removeaddons_button, 82, 26, 9, 8)
		...
		self.placeControl(removeaddondata_all_button, 92, 26, 9, 8)
		...
		self.placeControl(delet1, 75, 36, 9, 10)
		...
		self.placeControl(removeaddondata_u_button, 82, 36, 9, 8)
		...
		self.placeControl(removeaddondata_e_button, 92, 36, 9, 8)
		...
		self.placeControl(whitelist_edit_button, 22, 35, 9, 9)
		...
		self.placeControl(whitelist_view_button, 31, 35, 9, 9)
		...
		self.placeControl(whitelist_clear_button, 40, 35, 9, 9)
		...
		self.placeControl(whitelist_import_button, 49, 35, 9, 9)
		...
		self.placeControl(whitelist_export_button, 58, 35, 9, 9)
		...
		self.placeControl(autoadvanced_buttonQ, 22, 20, 9, 9)
		...
		self.placeControl(autoadvanced_button, 31, 20, 9, 9)
		...
		self.placeControl(currentsettings_button, 40, 20, 9, 9)
		...
		self.placeControl(removeadvanced_button, 49, 20, 9, 9)
